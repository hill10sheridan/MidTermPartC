...
public class TestUserprofile {
    ...
    public static void main(String[] args) {
        ...
        if (inGenre.equalsIgnoreCase("Comedy") 
                || inGenre.equalsIgnoreCase("Action")
                || inGenre.equalsIgnoreCase("Drama")
                || inGenre.equalsIgnoreCase("Mystery")) {
            UserProfile user = new UserProfile(inName, inGenre);
            System.out.println("Your userProfile was created");
        } else {
        System.out.println("UserProfile creation failed");
        }
